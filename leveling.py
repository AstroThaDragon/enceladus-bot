...
class Leveling(commands.Cog):
    def __init__(self, bot):
        ...
        self.NO_XP_CHANNELS = [1117403991266041906, 593398659530489858, 1306821711970435122, 1496628909570265199, 1473398974508437645, 1352415256584130590, 1117391981627318363, 1512300086057631925, 1510687468842782720, 1306602160527507456, 1296962529989361685] 
