...
ITEM_REGISTRY = {
    ...
    "laser_charge_cell": {"name": "Laser Charge Cell", "emoji": EMOJIS.get("laser_charge_cell", "🔋"), "max_quantity": 10, "sell_price": 200, "type": "Consumable", "desc": "Restores 2 mining laser charges."},
    "laser_power_cell": {"name": "Laser Power Cell", "emoji": EMOJIS.get("laser_power_cell", "⚡"), "max_quantity": 10, "sell_price": 375, "type": "Consumable", "desc": "Restores 5 mining laser charges."},
    "fuel_refill": {"name": "Laser Quantum Cell", "emoji": EMOJIS.get("fuel_refill", "⚛️"), "max_quantity": 5, "sell_price": 600, "type": "Consumable", "desc": "Instantly refills your starship mining laser to its current maximum charges."},
    "drone_battery": {"name": "Drone Battery Pack", "emoji": EMOJIS.get("drone_battery", "🔋"), "max_quantity": 10, "sell_price": 200, "type": "Consumable", "desc": "Restores 2 scavenge charges."},
    "drone_power_cell": {"name": "Drone Power Cell", "emoji": EMOJIS.get("drone_power_cell", "⚡"), "max_quantity": 10, "sell_price": 375, "type": "Consumable", "desc": "Restores 5 scavenge charges."},
    ...
    "stick": {"name": "Stick", "emoji": "🪵", "max_quantity": 1, "sell_price": 225, "type": "Defense Weapon", "desc": "It's a stick. Somehow, it helps."},
    "wooden_sword": {"name": "Wooden Sword", "emoji": "🗡️", "max_quantity": 1, "sell_price": 400, "type": "Defense Weapon", "desc": "A humble wooden sword with a small defensive chance."},
    "wooden_shield": {"name": "Wooden Shield", "emoji": "🛡️", "max_quantity": 1, "sell_price": 325, "type": "Defense Weapon", "desc": "A basic wooden shield that can prevent incoming hazards."},
    "wooden_spoon": {"name": "Wooden Spoon", "emoji": "🥄", "max_quantity": 1, "sell_price": 150, "type": "Defense Weapon", "desc": "A perfectly ordinary spoon. Surely this will protect you."},
    "heavy_wrench": {"name": "Suspiciously Heavy Wrench", "emoji": "🔧", "max_quantity": 1, "sell_price": 1000, "type": "Defense Weapon", "desc": "Technically a maintenance tool. Technically."},
    "plasma_cutter": {"name": "Plasma Cutter", "emoji": "🔫", "max_quantity": 1, "sell_price": 3000, "type": "Defense Weapon", "desc": "A precision plasma weapon recovered during the Halloween event. Provides a strong chance to prevent scavenging hazards."},
